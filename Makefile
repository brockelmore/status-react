...
ifndef IN_NIX_SHELL
	...
	@nix-shell --option extra-substituters https://nix-cache.status.im/ --trusted-public-keys "nix-cache.status.im-1:x/93lOfLU+duPplwMSBR+OlY4+mo+dCN7n0mr4oPwgY= cache.nixos.org-1:6NCHdD59X431o0gWypbMrAURkbJ16ZPMQFGspcDShjY="
else
